...
export default function UpdateProfileForm() {
  ...
  if (loadingProfile) {
    return (
        <main className="min-h-[calc(100vh-70px)] sm:min-h-[calc(100vh-120px)] flex items-center justify-center bg-gray-50 p-6">
      <div className="max-w-md mx-auto w-full p-4 bg-white shadow rounded space-y-4 animate-pulse">
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="max-w-md mx-auto w-full p-4 bg-white rounded shadow space-y-4">
      {/* Image de profil */}
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full cursor-pointer flex items-center justify-center gap-2 bg-blue-600 text-white py-2 rounded hover:bg-blue-700 transition"
      >
